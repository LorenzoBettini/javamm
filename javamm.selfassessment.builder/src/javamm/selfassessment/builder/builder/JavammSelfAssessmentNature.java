...
public class JavammSelfAssessmentNature implements IProjectNature {
	 ...
	 */
	public static final String STUDENT_PROJECT_SUFFIX_NAME = "student";

	/**
	 * Suffix of student's project
	 */
	public static final String STUDENT_PROJECT_SUFFIX = "." + STUDENT_PROJECT_SUFFIX_NAME;

	/**
	 * Suffix of student's project
	 */
	public static final String TEACHER_PROJECT_SUFFIX = ".teacher";

	/**
	 * Folder of student's project containing solution's .class files
	 */
	public static final String STUDENT_PROJECT_SOLUTION_PATH = "solution";
